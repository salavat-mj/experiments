...
def get_args():
    ...
    parser.add_argument('--dataset_dir', type=str, default='./datasets/style_ukiyoe_pretrained')
    parser.add_argument('--checkpoint_dir', type=str, default='./checkpoints/style_ukiyoe_pretrained')
